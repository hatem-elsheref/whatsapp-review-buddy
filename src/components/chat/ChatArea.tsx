    ...
    const unsub = subscribeToChat((evt: NewMessageEvent) => {
      ...
      setMessages((prev) => {
        ...
        const next: Message = {
          ...
          meta_message_id: evt.meta_message_id ?? null,
          ...
          type: evt.type,
          content: evt.content,
          template_name: evt.template_name ?? null,
          template_components: evt.template_components ?? null,
          interactive_payload: evt.interactive_payload ?? null,
          media_id: evt.media_id ?? null,
          media_url: null,
          media_download_url: evt.media_download_url ?? null,
          media_type: evt.media_type ?? null,
